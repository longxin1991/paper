...
\etitle{\uline{The effect of seismic array configuration on extracting weak seismic phases associated with inner core}}
...
\bibliography{innercore,noise,array,method}
