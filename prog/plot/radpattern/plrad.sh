...
psbasemap -R0/360/0/${rmax} -JP6i/90 -Bwsne -K > $ps
cat ${data} |psxy -R -J -Wthickest,red  -O -K>> $ps

echo -e "0 0\n""$tkf1 $rmax"|psxy -R -J -Wthickest,blue -O -K >> $ps
echo -e "0 0\n""$tkf2 $rmax"|psxy -R -J -Wthickest,blue -O -K >> $ps
